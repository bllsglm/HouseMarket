  ...
  return (
    <div className="flex flex-col mx-auto container ">
      <main className="m-8 shadow-2xl p-4">
        ...
        >
          {listing?.imageUrls.map((_url: string, index: number) => (
        ...
        <div className="flex flex-col">
          <div
            className="bg-green-500 p-2 rounded-full w-10 h-auto border border-black cursor-pointer hover:bg-opacity-50"
            onClick={() => {
